...
Summary_Accuracy_Testing

write.csv(Summary_AUC,file="Summary_AUC_Groundnut_Low_V1.csv")
write.csv(Predictions_All_traits,file="Predictions_All_traits_Groundnut_Low_V1.csv")
write.csv(Summary_Accuracy_Testing,file="Summary_Accuracy_Testing_Groundnut_Low_V1.csv")

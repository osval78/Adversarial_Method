...
#         k=1
      ...
      ##########Predictions of testing with optimal training set
...
write.csv(Summary_all_traits,file="Summary_all_traits_Groundnut_Top_V2.csv")
write.csv(Summary_all_traits_Testing,file="Summary_all_traits_Testing_Groundnut_Top_V2.csv")
write.csv(Predictions_All_traits,file="Predictions_All_traits_Groundnut_Top_V2.csv")

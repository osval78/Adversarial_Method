...
Pheno$Env="Japonica"
Pheno_E=Pheno
Summary_all_traits_Fold=data.frame()
Predictions_All_traits_Fold=data.frame()
Summary_all_traits_Testing_Fold=data.frame() 
...
#         k=1
  ...
  TT=apply(Summary_all_traits_Testing[,-1],2,mean)
  TT1=data.frame(Trait=Summary_all_traits_Testing[1,1], MSE=TT[1],COR=TT[2],NRMSE=TT[3],MSE_Opt=TT[4],COR_Opt=TT[5], NRMSE_Opt=TT[6])
  
  RR=mean(Summary_all_traits[, -1])
  RR1=data.frame(Trait=Summary_all_traits[1,1],  PR_AUC=RR)
  
  
Summary_all_traits_Fold=rbind(Summary_all_traits_Fold,RR1)
Predictions_All_traits_Fold=rbind(Predictions_All_traits_Fold,Predictions_All_traits)
Summary_all_traits_Testing_Fold=rbind(Summary_all_traits_Testing_Fold,TT1) 
}
write.csv(Summary_all_traits_Fold,file="Summary_all_traits_Japonica_Random_V3.csv")
write.csv(Summary_all_traits_Testing_Fold,file="Summary_all_traits_Testing_Japonica_Random_V3.csv")
write.csv(Predictions_All_traits_Fold,file="Predictions_All_traits_Japonica_Random_V3.csv")

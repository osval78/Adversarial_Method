...
write.csv(Summary_AUC_Fold,file="Summary_AUC_Japonica_Random_V3.csv")
write.csv(Summary_Accuracy_Testing_Fold,file="Summary_Accuracy_Testing_Japonica_Random_V3.csv")

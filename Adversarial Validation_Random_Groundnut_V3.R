...
#         k=1
  ...
  RR1=data.frame(Trait=Summary_all_traits[1,1],  ROC_AUC=RR)
...
write.csv(Summary_all_traits_Fold,file="Summary_all_traits_Groundnut_Random_V3.csv")
write.csv(Summary_all_traits_Testing_Fold,file="Summary_all_traits_Testing_Groundnut_Random_V3.csv")

...
write.csv(Summary_all_traits,file="Summary_all_traits_Groundnut_Low_V1.csv")
write.csv(Summary_all_traits_Testing,file="Summary_all_traits_Testing_Groundnut_Low_V1.csv")
write.csv(Predictions_All_traits,file="Predictions_All_traits_Groundnut_Low_V1.csv")

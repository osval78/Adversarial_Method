...
write.csv(Summary_all_traits,file="Summary_all_traits_Japonica_Top_V2.csv")
write.csv(Summary_all_traits_Testing,file="Summary_all_traits_Testing_Japonica_Top_V2.csv")
write.csv(Predictions_All_traits,file="Predictions_All_traits_Japonica_Top_V2.csv")
